...
- 🖥️ Experienced Cloud Data Engineer specializing in Google Cloud, Azure, and AWS. Possesses 7 years of expertise across finance, healthcare, legal, and automotive sectors. Holds certifications in Azure, AWS, and Astronomer. Actively shares knowledge as a speaker at Brazilian tech events. Demonstrates leadership as a Google Developer Groups - Cloud Brasília organizer and participates in programs like the GitHub Developer Program, Google Cloud AI Trusted Tester Program & Google Cloud Innovators. Multilingual in English, French, and Portuguese. Notable achievements include developing a groundbreaking Data Lake for a major automotive company and leading a Google community.
